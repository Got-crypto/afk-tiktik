...
const Upload = () => {
  ...
  return (
    <div className='flex justify-center w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#f8f8f8] '>
        <div className='bg-white w-[60%] justify-between rounded-lg xl:h-[80vh] flex gap-6 flex-wrap items-center p-14 pt-6 '>
            <div>
                <div>
